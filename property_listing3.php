...
.getting_email{
	...
	<DIV class="header_home">
				...
				<DIV class="left_of_header">
					...
					<BUTTON class="login" style="margin-left:80%"><a href="login.php" style="color:black;font-size:75%; opacity:0.5">LOG IN</a></BUTTON>   
					<BUTTON class="login"><a href="sign_up2.php" style="color:black;font-size:75%;opacity:0.5">SIGN UP</a></BUTTON>
	...
	<div class="container-fluid">
		<button type="button" class="btn" data-toggle="collapse" data-target="#demo">Filters</button>


		<div id="demo" class="collapse">

		<br>
	<FORM method=get action=property_listing3.php>
...
<div id="slider-range"></div>
	...
	<!---	<input type="range" min="500" max="50000" >   -->
		<hr >
			...
			<br>
			<br>
		<input type="submit" name="filter_btn" value="APPLY FILTERS" class="apply_filters">
	</FORM>	
	</div>
	</div>
